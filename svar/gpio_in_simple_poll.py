...
# IMPORT AREA
import sys 
import RPi.GPIO as GPIO      # import RPi.GPIO module, alias it to new name 'GPIO'
...
if __name__ == "__main__":
   ...
   while True:
      ...
      print i
      time.sleep(0.2)          # sleep a while to off load the CPU
   
   sys.exit(0) # Exit success to outer bash shell
