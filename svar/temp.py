...
# der celsiusområdet er fra -10 til +10 grader celsius (begge tall inklusive)
#
# Andre funksjon skal 
...
#
# PS: ikke bry deg om rette marger denne gang eller antall desimaler i tallene
