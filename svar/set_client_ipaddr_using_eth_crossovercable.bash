...
# again
#
# Notice: This script should be executed as a 'sudo' script: 'sudo thisscript'
#
...
while true;do
   quest_bin "which IP base do you want on this client? (should be same as base as on the remote ssh server)"  "192.168.0" "192.168.1" "10.0.0"
   RET=$?
   # echo "RET=$RET"
   IP_ADDRB=""
   if [ $RET -eq 1 ];then
